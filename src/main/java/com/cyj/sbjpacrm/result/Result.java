package com.cyj.sbjpacrm.result;
...
public class Result {
	...
	public void setCode(Integer code) {
		this.code = code;
		switch (code) {
			case 1:setMsg(ResultConst.UNLOGIN);	break;//1未登录
			case 2:setMsg(ResultConst.TOKENEXPIRED);	break;//2token过期
			case 3:setMsg(ResultConst.NOPERMISSION);	break;//3无权访问
	...
	public String toString() {
		return "Result [state=" + state + ", code=" + code + ", msg=" + msg
				+ ", data=" + data + "]";
	}
